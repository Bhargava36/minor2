<div class="row mt-5">
    ...
    <div id="" class="col-md-6 d-flex align-items-center">
        <img src="./assets/images/Home.png" width="100%" height="90%" alt="">
    </div>
</div>
<div class="row">
    <div class="col-12">
        <p class="text">We help you in finding Blood Donors</p>
    </div>
</div>